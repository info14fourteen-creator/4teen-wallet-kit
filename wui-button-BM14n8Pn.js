...
`, c = function(e, t, n, r) {
	...
	loadingTemplate() {
		if (this.loading) {
			let e = d[this.size];
			return r`<wui-loading-spinner color=${this.disabled ? l.disabled : l[this.variant]} size=${e}></wui-loading-spinner>`;
		}
		return r``;
	}
};
f.styles = [
	...
	e,
	s
], c([o()], f.prototype, "size", void 0), c([o({ type: Boolean })], f.prototype, "disabled", void 0), c([o({ type: Boolean })], f.prototype, "fullWidth", void 0), c([o({ type: Boolean })], f.prototype, "loading", void 0), c([o()], f.prototype, "variant", void 0), c([o({ type: Boolean })], f.prototype, "hasIconLeft", void 0), c([o({ type: Boolean })], f.prototype, "hasIconRight", void 0), c([o()], f.prototype, "borderRadius", void 0), c([o()], f.prototype, "textVariant", void 0), f = c([n("wui-button")], f);
//#endregion
