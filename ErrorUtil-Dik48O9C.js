import { V as e } from "./ModalController-DHlkqy_7.js";
var t = {
	...
	ALERT_ERRORS: {
		...
		ORIGIN_NOT_ALLOWED: {
			...
			debugMessage: () => `The origin ${e() ? window.origin : "unknown"} is not in your allow list. Please update your allowed domains at https://dashboard.reown.com.`
		},
		IFRAME_LOAD_FAILED: {
			code: "APKT003",
	...
	ALERT_WARNINGS: { LOCAL_CONFIGURATION_IGNORED: { debugMessage: (e) => `[Reown Config Notice] ${e}` } }
};
//#endregion
export { t };
