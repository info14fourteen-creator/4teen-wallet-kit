...
var v = globalThis, y = (e) => e, b = v.trustedTypes, x = b ? b.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, S = "$lit$", C = `lit$${Math.random().toFixed(9).slice(2)}$`, w = "?" + C, se = `<${w}>`, T = document, E = () => T.createComment(""), D = (e) => e === null || typeof e != "object" && typeof e != "function", O = Array.isArray, k = (e) => O(e) || typeof e?.[Symbol.iterator] == "function", A = "[ 	\n\f\r]", j = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, M = /-->/g, N = />/g, P = RegExp(`>|${A}(?:([^\\s"'>=/]+)(${A}*=${A}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`, "g"), F = /'/g, I = /"/g, L = /^(?:script|style|textarea|title)$/i, R = (e) => (t, ...n) => ({
	_$litType$: e,
	strings: t,
	values: n
}), ce = R(1), le = R(2), z = Symbol.for("lit-noChange"), B = Symbol.for("lit-nothing"), V = /* @__PURE__ */ new WeakMap(), H = T.createTreeWalker(T, 129);
function U(e, t) {
...
var W = (e, t) => {
	...
	for (let t = 0; t < n; t++) {
		...
		a += o === j ? n + se : l >= 0 ? (r.push(s), n.slice(0, l) + S + n.slice(l) + C + d) : n + C + (l === -2 ? t : d);
	}
	...
	constructor({ strings: t, _$litType$: n }, r) {
		let i;
		this.parts = [];
		let a = 0, o = 0, s = t.length - 1, c = this.parts, [l, u] = W(t, n);
			...
			if (i.nodeType === 1) {
				...
				if (L.test(i.tagName)) {
					...
					if (t > 0) {
						...
						for (let n = 0; n < t; n++) i.append(e[n], E()), H.nextNode(), c.push({
							type: 2,
							index: ++a
						});
						i.append(e[t], E());
...
function K(e, t, n = e, r) {
	...
	return i?.constructor !== a && (i?._$AO?.(!1), a === void 0 ? i = void 0 : (i = new a(e), i._$AT(e, n, r)), r === void 0 ? n._$Cl = i : (n._$Co ?? (n._$Co = []))[r] = i), i !== void 0 && (t = K(e, i._$AS(e, t.values), i, r)), t;
}
var q = class {
	constructor(e, t) {
	...
	_$AI(e, t = this) {
		e = K(this, e, t), D(e) ? e === B || e == null || e === "" ? (this._$AH !== B && this._$AR(), this._$AH = B) : e !== this._$AH && e !== z && this._(e) : e._$litType$ === void 0 ? e.nodeType === void 0 ? k(e) ? this.k(e) : this._(e) : this.T(e) : this.$(e);
	}
	O(e) {
	...
	_(e) {
		this._$AH !== B && D(this._$AH) ? this._$AA.nextSibling.data = e : this.T(T.createTextNode(e)), this._$AH = e;
	}
	$(e) {
		let { values: t, _$litType$: n } = e, r = typeof n == "number" ? this._$AC(e) : (n.el === void 0 && (n.el = G.createElement(U(n.h, n.h[0]), this.options)), n);
	...
	_$AI(e, t = this, n, r) {
		...
		if (i === void 0) e = K(this, e, t, 0), a = !D(e) || e !== this._$AH && e !== z, a && (this._$AH = e);
		else {
			let r = e, o, s;
			for (e = i[0], o = 0; o < i.length - 1; o++) s = K(this, r[n + o], t, o), s === z && (s = this._$AH[o]), a || (a = !D(s) || s !== this._$AH[o]), s === B ? e = B : e !== B && (e += (s ?? "") + i[o + 1]), this._$AH[o] = s;
		}
		a && !r && this.j(e);
	}
	j(e) {
	...
	B: X,
	F: de
}, pe = v.litHtmlPolyfillSupport;
pe?.(G, J), (v.litHtmlVersions ?? (v.litHtmlVersions = [])).push("3.3.2");
var me = (e, t, n) => {
	let r = n?.renderBefore ?? t, i = r._$litPart$;
	if (i === void 0) {
		let e = n?.renderBefore ?? null;
		r._$litPart$ = i = new J(t.insertBefore(E(), e), e, void 0, n ?? {});
	}
	return i._$AI(e), i;
}, Q = globalThis, $ = class extends _ {
	constructor() {
...
he?.({ LitElement: $ }), (Q.litElementVersions ?? (Q.litElementVersions = [])).push("4.2.2");
//#endregion
export { fe as a, m as c, ce as i, o as l, B as n, le as o, z as r, h as s, $ as t, a as u };
