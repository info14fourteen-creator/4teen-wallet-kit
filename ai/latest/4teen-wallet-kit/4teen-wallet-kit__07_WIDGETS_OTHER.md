...
:root {
  ...
  --fourteen-cabinet-green: rgb(23, 224, 58);
  --fourteen-cabinet-green-soft: rgba(23, 224, 58, 0.12);
  --fourteen-cabinet-graphite: rgb(26, 26, 26);
  --fourteen-cabinet-graphite-soft: rgba(26, 26, 26, 0.5);
  --fourteen-cabinet-steel: rgb(77, 77, 77);
  --fourteen-cabinet-steel-soft: rgba(77, 77, 77, 0.24);
  --fourteen-cabinet-light: rgb(242, 242, 242);
  --fourteen-cabinet-white: rgb(255, 255, 255);
...
.fourteen-ambassador-cabinet-action--top-refresh {
  min-width: 96px;
}
...
.fourteen-ambassador-cabinet-empty__hint {
  margin-top: 14px;
  font-size: 12px;
  color: var(--fourteen-cabinet-text-faint);
}
...
.fourteen-ambassador-cabinet-card--green {
  border-color: rgba(23, 224, 58, 0.22);
  box-shadow:
    inset 0 0 0 1px rgba(23, 224, 58, 0.18),
    0 0 0 1px rgba(23, 224, 58, 0.06);
}
...
.fourteen-ambassador-cabinet-card--amber {
  ...
  box-shadow:
    inset 0 0 0 1px rgba(255, 105, 0, 0.14),
...
.fourteen-ambassador-cabinet-card--blue {
  ...
  box-shadow:
    inset 0 0 0 1px rgba(242, 242, 242, 0.06),
    0 0 0 1px rgba(255, 255, 255, 0.03);
}

.fourteen-ambassador-cabinet-card--accent {
  border-color: rgba(255, 105, 0, 0.3);
  box-shadow:
    inset 0 0 0 1px rgba(255, 105, 0, 0.16),
    0 0 0 1px rgba(255, 105, 0, 0.05);
}
...
.fourteen-ambassador-cabinet-section__toggle {
  width: 100%;
  padding: 16px;
  border: 0;
  background: transparent;
...
.fourteen-ambassador-cabinet-section__toggle-left {
  display: flex;
  align-items: center;
  gap: 12px;
  min-width: 0;
...
.fourteen-ambassador-cabinet-section__icon {
  width: 24px;
  height: 24px;
  border-radius: 999px;
  display: inline-flex;
...
.fourteen-ambassador-cabinet-section__content[hidden] {
  display: none !important;
}

.fourteen-ambassador-cabinet-actions-helper {
  margin-bottom: 12px;
  font-size: 13px;
  line-height: 1.5;
  color: var(--fourteen-cabinet-text-soft);
...
.fourteen-ambassador-cabinet-section__toggle:focus-visible {
...
:root {
  ...
  --fourteen-amb-border-strong: rgba(255, 255, 255, 0.12);
...
.fourteen-ambassador-popover__text p {
  margin: 0 0 10px 0;
}

.fourteen-ambassador-popover__text p:last-child {
  margin-bottom: 0;
}

.fourteen-ambassador-popover__actions {
  display: flex;
  flex-wrap: wrap;
  gap: 10px;
  margin-top: 14px;
...
.fourteen-ambassador-popover__action {
  appearance: none;
  border: 0;
  outline: 0;
  text-decoration: none;
...
.fourteen-ambassador-popover__action--primary:hover {
  transform: translateY(-1px);
  box-shadow: 0 14px 28px rgba(255, 105, 0, 0.28);
  filter: brightness(1.03);
}
...
.fourteen-ambassador-popover__action--secondary:hover {
  transform: translateY(-1px);
  background: rgba(255, 255, 255, 0.08);
  border-color: var(--fourteen-amb-border-strong);
}
