import { _ as e, f as t, s as n, t as r } from "./exports-D_wXhA01.js";
import { i, l as a, o, t as s } from "./lit-CKWVc9vf.js";
...
var l = /* @__PURE__ */ t(((e, t) => {
	...
	var n = {
		...
		PriorityQueue: {
			make: function(e) {
				...
				for (i in e = e || {}, t) t.hasOwnProperty(i) && (r[i] = t[i]);
	...
	var t = C(), n = E(), r = D(), i = k(), a = A(), o = S(), s = u(), c = j();
	function l(e) {
	...
	var t = u(), n = d(), r = f(), i = p(), a = m(), o = h(), s = g(), c = _(), l = b(), v = w(), y = T(), x = C(), S = M();
	function E(e, t) {
	...
	function F(e, n, r, a) {
		...
		return E(u, n), D(u), O(u, n), A(u, r, 0), n >= 7 && k(u, n), j(u, l), isNaN(a) && (a = s.getBestMask(u, A.bind(null, u, r))), s.applyMask(a, u), A(u, r, a), {
			modules: u,
			version: n,
	...
	e.render = function(e, i, a) {
		...
		let i = r;
		i === void 0 && (!n || !n.getContext) && (i = n, n = void 0), i || (i = {});
...
function V(e, t, n) {
	return e === t ? !1 : (e - t < 0 ? t - e : e - t) <= n + R;
}
function H(e, t) {
	let n = Array.prototype.slice.call(L.create(e, { errorCorrectionLevel: t }).modules.data, 0), r = Math.sqrt(n.length);
	return n.reduce((e, t, n) => (n % r === 0 ? e.push([t]) : e[e.length - 1].push(t)) && e, []);
}
var U = { generate({ uri: e, size: t, logoSize: n, dotColor: r = "#141414" }) {
	let i = [], a = H(e, "Q"), s = t / a.length, c = [
		{
			x: 0,
			y: 0
		},
	...
	c.forEach(({ x: e, y: t }) => {
		let n = (a.length - B) * s * e, l = (a.length - B) * s * t, u = .45;
	...
	let l = Math.floor((n + 25) / s), u = a.length / 2 - l / 2, d = a.length / 2 + l / 2 - 1, f = [];
	a.forEach((e, t) => {
		e.forEach((e, n) => {
			if (a[t][n] && !(t < B && n < B || t > a.length - (B + 1) && n < B || t < B && n > a.length - (B + 1)) && !(t > u && t < d && n > u && n < d)) {
				let e = t * s + s / 2, r = n * s + s / 2;
				f.push([e, r]);
			}
		});
	});
	...
	return f.forEach(([e, t]) => {
		...
		let n = t.filter((e) => t.every((t) => !V(e, t, s)));
		return [Number(e), n];
	}).forEach(([e, t]) => {
		t.forEach((t) => {
			i.push(o`<circle cx=${e} cy=${t} fill=${r} r=${s / z} />`);
		});
	}), Object.entries(p).filter(([e, t]) => t.length > 1).map(([e, t]) => {
		let n = t.filter((e) => t.some((t) => V(e, t, s)));
		return [Number(e), n];
	}).map(([e, t]) => {
		t.sort((e, t) => e < t ? -1 : 1);
		let n = [];
		for (let e of t) {
			let t = n.find((t) => t.some((t) => V(e, t, s)));
			t ? t.push(e) : n.push([e]);
		}
...
`, G = function(e, t, n, r) {
	...
	render() {
     ...
     --local-icon-color: ${this.color ?? K}
    `, i`${this.templateVisual()} ${this.templateSvg()}`;
	}
	templateSvg() {
		let e = this.theme === "light" ? this.size : this.size - 32;
		return o`
	...
	templateVisual() {
		return this.imageSrc ? i`<wui-image src=${this.imageSrc} alt=${this.alt ?? "logo"}></wui-image>` : this.farcaster ? i`<wui-icon
        class="farcaster"
        size="inherit"
        color="inherit"
        name="farcaster"
      ></wui-icon>` : i`<wui-icon size="inherit" color="inherit" name="walletConnect"></wui-icon>`;
	}
};
q.styles = [n, W], G([c()], q.prototype, "uri", void 0), G([c({ type: Number })], q.prototype, "size", void 0), G([c()], q.prototype, "theme", void 0), G([c()], q.prototype, "imageSrc", void 0), G([c()], q.prototype, "alt", void 0), G([c()], q.prototype, "color", void 0), G([c({ type: Boolean })], q.prototype, "arenaClear", void 0), G([c({ type: Boolean })], q.prototype, "farcaster", void 0), q = G([r("wui-qr-code")], q);
//#endregion
